...
import com.itsupport.backend.Mapper.EquipmentMapper;
...
private final EquipmentMapper.Tickmapper tickmapper;


    public TicketService(TicketRepository ticketRepository, EquipmentMapper.Tickmapper tickmapper) {
        this.ticketRepository = ticketRepository;
        this.tickmapper = tickmapper;
    }

    public TicketDto addTick(TicketDto ticketDto) {
        Ticket ticket = EquipmentMapper.Tickmapper.toEntity(ticketDto);
